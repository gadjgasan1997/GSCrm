class EmployeePositionsManagement {
    ...
    /**
     * Заполняет поля фильтров по списку всех должностей организации значениями(в модальном окне урпавления должностями)
     * @param {*} response 
     */
    ...
    /**
     * Заполняет поля фильтров по списку выбранных должностей сотрудника значениями(в модальном окне урпавления должностями)
     * @param {*} response 
     */
