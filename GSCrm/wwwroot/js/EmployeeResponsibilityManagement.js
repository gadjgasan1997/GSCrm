class EmployeeResponsibilityManagement {
    ...
    InitializeResps() {
        return new Promise((resolve, reject) => {
            ...
            this.ClearEmpRespManagementSearch().then(() => {
                ...
                // Получение и рендеринг списка полномочий
    ...
    /**
     * Метод заполняет поля фильтров по всем полномочиям организации пришедшими с сервера значениями
     * @param {*} response 
     */
    ...
    /**
     * Метод заполняет поля фильтров по выбранным полномочиям сотрудника пришедшими с сервера значениями
     * @param {*} response 
     */
